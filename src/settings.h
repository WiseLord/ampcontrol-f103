...
enum {
    ...
    PARAM_AUDIO_BASS_FREQ,
    PARAM_AUDIO_BASS_QUAL,
    PARAM_AUDIO_MIDDLE_FREQ,
    PARAM_AUDIO_MIDDLE_QUAL,
    PARAM_AUDIO_TREBLE_FREQ,
    PARAM_AUDIO_SUB_CUT_FREQ,
    PARAM_AUDIO_LOUD_PEAK_FREQ,
